...
# CORS — allow frontend dev server and deployed Netlify app
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
        "http://localhost:3000",
        "https://dasik-f2daa8.netlify.app",
        "https://main--dasik-f2daa8.netlify.app",
        "https://skillwatch-ai.onrender.com",
    ],
